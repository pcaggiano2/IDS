...
class GCNModelSIGVAE(nn.Module):
    ...
    def __init__(self, args, device='cpu', encsto='semi', gdc='ip', ndist = 'Bernoulli', copyK=1, copyJ=1, ):
    ...
    def forward(self, x, adj, val=None):
        mu, logvar, snr = self.encode(x[0], adj[0])
