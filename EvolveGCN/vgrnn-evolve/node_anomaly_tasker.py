...
class Anomaly_Detection_Tasker():
    ...
    def open_graph(self, capture_name, graph_type, graph_name, split):
        #print(graph_name)
        if "train" in split or "val" in split or split == "test_mixed" or split == "test_malicious" or split == "test_benign" or "iot23" in split:
        ...
        elif split == "IoTID20_benign" or split == "IoTID20_mixed":
