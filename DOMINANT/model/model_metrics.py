...
def average_prediction_time(prediction_time, dataloader):
    """Computes the average prediction time needed from the model to make a prediction.
    """
    av_pred_time = prediction_time/len(dataloader)
